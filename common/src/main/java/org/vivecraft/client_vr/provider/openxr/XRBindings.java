...
public class XRBindings {
    ...
    public static HashSet<String> supportedHeadsets() {
        ...
        // }
        // if
        // (MCOpenXR.get().session.getCapabilities().XR_HTC_vive_cosmos_controller_interaction)
        // {
    ...
    private static HashSet<Pair<String, String>> quest2Bindings() {
        ...
        set.add(new MutablePair<>("/actions/global/in/vivecraft.key.ingameMenuButton",
                "/user/hand/left/input/y/click"));
        set.add(new MutablePair<>("/actions/global/in/vivecraft.key.toggleKeyboard",
                "/user/hand/left/input/x/click"));
        set.add(new MutablePair<>("/actions/global/in/key.inventory", "/user/hand/left/input/trigger/value"));
        ...
        set.add(new MutablePair<>("/actions/gui/in/vivecraft.key.guiLeftClick",
                "/user/hand/right/input/trigger/value"));
        set.add(new MutablePair<>("/actions/gui/in/vivecraft.key.guiRightClick", "/user/hand/right/input/a/click"));
        set.add(new MutablePair<>("/actions/gui/in/vivecraft.key.guiScrollAxis",
                "/user/hand/right/input/thumbstick/y"));

        set.add(new MutablePair<>("/actions/ingame/in/vivecraft.key.hotbarPrev",
                "/user/hand/right/input/thumbstick/dpad_up"));
        set.add(new MutablePair<>("/actions/ingame/in/vivecraft.key.hotbarNext",
        ...
        // set.add(new MutablePair<>("/actions/ingame/in/vivecraft.key.teleport",
        ...
        // set.add(new
        // MutablePair<>("/actions/ingame/in/vivecraft.key.teleportFallback",
        // "/user/hand/left/input/trigger/value"));
        set.add(new MutablePair<>("/actions/ingame/in/key.jump", "/user/hand/left/input/squeeze"));
        set.add(new MutablePair<>("/actions/ingame/in/vivecraft.key.freeMoveStrafe",
                "/user/hand/left/input/thumbstick"));
        set.add(new MutablePair<>("/actions/ingame/in/key.sneak", "/user/hand/right/input/squeeze"));
        // set.add(new MutablePair<>("/actions/ingame/in/vivecraft.key.rotateLeft",
        // "/user/hand/right/input/thumbstick/dpad_left"));
        // set.add(new MutablePair<>("/actions/ingame/in/vivecraft.key.rotateRight",
        //         "/user/hand/right/input/thumbstick/dpad_right"));

        set.add(new MutablePair<>("/actions/ingame/in/vivecraft.key.rotateAxis",
    ...
    private static HashSet<Pair<String, String>> viveBindings() {
        ...
        set.add(new MutablePair<>("/actions/gui/in/vivecraft.key.guiMiddleClick",
                "/user/hand/right/input/squeeze/click"));
        set.add(new MutablePair<>("/actions/gui/in/vivecraft.key.guiLeftClick",
                "/user/hand/right/input/trigger/click"));
        set.add(new MutablePair<>("/actions/gui/in/vivecraft.key.guiRightClick",
    ...
    private static HashSet<Pair<String, String>> cosmosBindings() {
        ...
        set.add(new MutablePair<>("/actions/gui/in/vivecraft.key.guiRightClick", "/user/hand/right/input/a/click"));
        set.add(new MutablePair<>("/actions/gui/in/vivecraft.key.guiScrollAxis",
                "/user/hand/right/input/joystick/scroll"));
        ...
        set.add(new MutablePair<>("/actions/ingame/in/key.use", "/user/hand/right/input/a/click"));
        set.add(new MutablePair<>("/actions/ingame/in/vivecraft.key.freeMoveStrafe",
                "/user/hand/left/input/joystick/position"));
        set.add(new MutablePair<>("/actions/ingame/in/vivecraft.key.rotateAxis",
                "/user/hand/right/input/joystick/position"));
        set.add(new MutablePair<>("/actions/ingame/in/vivecraft.key.teleportFallback",
                "/user/hand/left/input/trigger/pull"));
